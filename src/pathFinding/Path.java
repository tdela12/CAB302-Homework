...
public class Path implements Iterable<Location>{
    ...
    /*
    * A Path object is constructed with an ArrayList of locations
    ...
    */
    ...
    /*
    * Returns whether the given coordinates describe a location in the ArrayList inner
    * @param x The x coordinate of the location
    * @param y The y coordinate of the location
    * @return True if the given location is in the ArrayList inner, False otherwise.
    * */
